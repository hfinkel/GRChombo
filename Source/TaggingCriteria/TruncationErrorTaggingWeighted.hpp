...
#ifndef TRUNCATIONERRORTAGGINGWEIGHTED_HPP_
#define TRUNCATIONERRORTAGGINGWEIGHTED_HPP_

#include "Cell.hpp"

class TruncationErrorTaggingWeighted
{
  protected:
  ...
  public:
    TruncationErrorTaggingWeighted(const int a_num_truncation_error_vars,
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        else
        {
	      ...
	      //                in_vars[ivar] = current_cell.load_vars(ivar);
                in_vars[ivar] = current_cell.load_vars(c_Ham_abs_sum);
            }
...
#endif /* TRUNCATIONERRORTAGGINGWEIGHTED_HPP_ */
